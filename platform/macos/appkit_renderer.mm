...
void AppKitRenderer::RenderCommand(CGContextRef context, const DrawExternalTextureCommand& command) {
  DrawCGImage(
      context,
...
void AppKitRenderer::RenderCommand(CGContextRef context, const DrawLineCommand& command) {
