...
ToastStyle FlatToastStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .corner_radii = CornerRadii{theme.shapes.small},
...
SnackBarStyle FlatSnackBarStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .action_corner_radii = CornerRadii{theme.shapes.small},
...
DialogStyle FlatDialogStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .action_corner_radii = CornerRadii{theme.shapes.extra_small},
...
ChipStyle MaterialChipStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .selected_border = std::nullopt,
      .disabled_border = Border{disabled_border, 1.0F},
      .disabled_selected_border = std::nullopt,
...
SelectStyle MaterialSelectStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .corner_radii = CornerRadii{theme.shapes.extra_small},
      .popup_corner_radii = CornerRadii{theme.shapes.small},
      .indication = MaterialIndication(theme.colors.on_surface, theme),
...
DatePickerStyle MaterialDatePickerStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .row_spacing = 4.0F,
      .header_height = 48.0F,
      .corner_radii = CornerRadii{theme.shapes.extra_large},
...
TimePickerStyle MaterialTimePickerStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .period_border = Border{theme.colors.outline, 1.0F},
      ...
      .field_corner_radii = CornerRadii{theme.shapes.small},
      .period_width = 52.0F,
      .period_spacing = theme.spacing.small + theme.spacing.extra_small,
      .period_corner_radii = CornerRadii{theme.shapes.small},
      ...
      .filled =
          {
              ...
              .focused_border = theme.colors.primary,
              .disabled_border = disabled_indicator,
              .corner_radii = CornerRadii::Top(theme.shapes.extra_small),
              .minimum_height = 56.0F,
          },
      .outlined =
          {
...
CheckboxStyle MaterialCheckboxStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .unchecked_border = Border{theme.colors.on_surface_variant, 2.0F},
      .disabled_checked_background = disabled,
      .disabled_checkmark = theme.colors.surface,
      .disabled_unchecked_border = Border{disabled, 2.0F},
      .corner_radii = CornerRadii{2.0F},
  };
}
...
SnackBarStyle MaterialSnackBarStyle(const ThemeSpec& theme) {
  return {
      ...
      .action_corner_radii = CornerRadii{theme.shapes.full},
...
DialogStyle MaterialDialogStyle(const ThemeSpec& theme) {
  return {
      ...
      .action_spacing = theme.spacing.small,
      .action_separator_thickness = 0.0F,
      .action_corner_radii = CornerRadii{20.0F},
...
ChipStyle DefaultChipStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .corner_radii = CornerRadii{14.0F},
      .indication = std::nullopt,
...
TimePickerStyle DefaultTimePickerStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .period_border = Border{border, 1.0F},
      .hand = theme.colors.primary,
      .border = Border{border, 1.0F},
      .validation_error = theme.colors.error,
      .header_style = TextStyle{
      ...
      .field_corner_radii = CornerRadii{theme.shapes.extra_small},
      .period_width = 44.0F,
      .period_spacing = theme.spacing.small,
      .period_corner_radii = CornerRadii{theme.shapes.extra_small},
      .content_spacing = theme.spacing.medium,
      ...
      .filled =
          {
              ...
              .focused_border = theme.colors.primary,
              .disabled_border = disabled_border,
              .corner_radii = CornerRadii::Top(theme.shapes.extra_small + 2.0F),
      ...
      .outlined =
          {
              ...
              .focused_border = theme.colors.primary,
              .disabled_border = disabled_border,
              .corner_radii = CornerRadii{theme.shapes.extra_small + 2.0F},
              .minimum_height = 36.0F,
          },
...
CheckboxStyle DefaultCheckboxStyle(const ThemeSpec& theme) {
  ...
  return {
      ...
      .checked_background = theme.colors.primary,
      .checkmark = theme.colors.on_primary,
      .unchecked_border = Border{border, 2.0F},
      .disabled_checked_background = disabled,
      .disabled_checkmark = theme.colors.surface,
      .disabled_unchecked_border = Border{disabled, 2.0F},
      .corner_radii = CornerRadii{theme.shapes.extra_small},
