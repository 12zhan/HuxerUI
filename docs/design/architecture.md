...
| `components/` | Layout and scrolling containers, controls including Text, TextField, and SelectionArea, navigation components, themes, presentation services, tooltips, and interaction visuals |
| `text/` | Text models, shared paragraph-layout support, editing protocol, and validation |
