...
The expansion adds a destination clip and a view-box transform, then reuses the existing immutable solid or gradient Path fill, stroke, clip, and transform commands.
